...
-- 2. Authentication Providers Table (Allows multiple login types per user)
...
CREATE INDEX idx_user_providers_search ON user_providers(provider_type, provider_id);
