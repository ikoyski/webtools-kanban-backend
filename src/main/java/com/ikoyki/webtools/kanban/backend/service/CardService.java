...
public class CardService {
    ...
    @Transactional
    public Card createCard(UUID columnId, String title, String description, String priority, java.time.LocalDate dueDate, List<String> labels) {
    ...
    @Transactional
    public Card updateCard(UUID id, String title, String description, String priority, java.time.LocalDate dueDate, List<String> labels) {
    ...
    @Transactional
    public Card moveCard(UUID cardId, UUID destColumnId, Integer destPosition) {
        ...
        if (sourceColumnId.equals(destColumnId)) {
            ...
            List<Card> destSiblings = cardRepository.findByColumnIdOrderByPositionAsc(destColumnId);
    ...
    private void reassignPositions(List<Card> cards) {
